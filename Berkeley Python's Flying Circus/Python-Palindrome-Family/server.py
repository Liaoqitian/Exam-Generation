...
def generate(data):    
    ...
    requirement = ""
    if variant == 'all': 
        text = """A palindrome-All is a string that is spelled the same way forwards and backwards. In other words, the first letter <b>MUST</b> equal the last letter, 
        the second letter <b>MUST</b> equal the second to last letter ... etc. """
        ...
        and the second letter <b>MUST NOT</b> equal the second to last letter ... etc. """ 
